			...
			<div className="flex flex-col gap-5 lg:flex-row">
				<div className="flex flex-col border-2 border-gray-300 bg-white p-5 hover:border-black">
					...
					<div className="flex flex-row items-end gap-2">
						<h3 className="mt-2 flex text-5xl font-bold">{stats.totalUserCount}</h3>
				...
				<div className="flex flex-col border-2 border-gray-300 bg-white p-5 hover:border-black">
					...
					<div className="flex flex-row items-end gap-2">
						<h3 className="mt-2 flex text-5xl font-bold">{stats.postCount}</h3>
				...
				<div className="flex flex-col border-2 border-gray-300 bg-white p-5 hover:border-black">
					...
					<div className="flex flex-row items-end gap-2">
						<h3 className="mt-2 flex text-5xl font-bold">{stats.journalCount}</h3>
